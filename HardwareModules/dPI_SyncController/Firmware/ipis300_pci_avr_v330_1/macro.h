...
#define       Sync_Option          _Sync_Option.def_byte
#define       Tri_Mode          _Sync_Option.bit.bit0	
#define       Shutter_Mode          _Sync_Option.bit.bit1
#define       T_Tri_Mode          _Sync_Option.bit.bit4

#define       Trigger_Mode      _Sync_Option.bit.bit7
