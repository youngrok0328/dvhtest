...
struct stBatchInspResult
{
    ...
    long nInvalid;
    long nEmpty;
    long nDouble; //kircheis_3DEmpty
};

static const UINT MsgSendInspDataVsToDL = ::RegisterWindowMessage(_T("UserMessageSendInspDataToDL"));
...
#define __VISION_BATCH_INSPECTION_UI_CLASS_EXPORT__
