...
LRESULT ViewVision::OnConnectionUpdatedFromAutomation(WPARAM wParam, LPARAM lParam)
{
...
LRESULT ViewVision::OnDataReceivedFromAutomation(WPARAM wParam, LPARAM lParam)
{
