...
class VisionInspectionLid3D;
class VisionInspectionLid3DPara;
struct ProcessingDlgInfo;

//HDR_6_________________________________ Header body
//
class CDlgVisionInspectionLid3D : public CDialog
{
    DECLARE_DYNAMIC(CDlgVisionInspectionLid3D)

public:
    CDlgVisionInspectionLid3D(const ProcessingDlgInfo& procDlgInfo, VisionInspectionLid3D* pVisionInsp,
        CWnd* pParent = NULL); // 표준 생성자입니다.
    virtual ~CDlgVisionInspectionLid3D();
...
public:
    ...
    VisionInspectionLid3D* m_pVisionInsp;
    VisionInspectionLid3DPara* m_pVisionPara;
...
public:
    ...
    void DrawSubstrateROI();
    void DrawLidTiltROI();
    void DrawLidHeightROI();

    void ClickedButtonImageCombine();
    void ClickedButtonImportLidHeightROI_MapData();
    void ClickedButtonExportLidHeightROI_MapData();
