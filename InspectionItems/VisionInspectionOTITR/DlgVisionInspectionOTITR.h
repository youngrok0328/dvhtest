...
//
class CDlgVisionInspectionOTITR : public CDialog
{
    DECLARE_DYNAMIC(CDlgVisionInspectionOTITR)

public:
    CDlgVisionInspectionOTITR(const ProcessingDlgInfo& procDlgInfo, VisionInspectionOTITR* pVisionInsp,
        CWnd* pParent = NULL); // 표준 생성자입니다.
    virtual ~CDlgVisionInspectionOTITR();
...
public:
    ...
    VisionInspectionOTITR* m_pVisionInsp;
    VisionInspectionOTITRPara* m_pVisionPara;
...
public:
    ...
    void ClickedButtonCoverTapeAlignImageCombine();
    void ClickedButtonSealingAlignImageCombine();

    void ShowCoverTapeSearchROI();
    void ShowSealingSearchROI();

    void ShowCoverTapeSearchLine();
    void ShowSealingSearchLine();
};
