...
//
class CDlgVisionInspectionBgaBallBridge : public CDialog
{
    DECLARE_DYNAMIC(CDlgVisionInspectionBgaBallBridge)

public:
    CDlgVisionInspectionBgaBallBridge(const ProcessingDlgInfo& procDlgInfo, VisionInspectionBgaBallBridge* pVisionInsp,
        CWnd* pParent = NULL); // 표준 생성자입니다.
    virtual ~CDlgVisionInspectionBgaBallBridge();
...
public:
    ...
    VisionInspectionBgaBallBridge* m_pVisionInsp;
    VisionInspectionBgaBallBridgePara* m_pVisionPara;
...
public:
    ...
    void ShowThresholdImage(BOOL bThreshImage);
    void DrawBallLink();
    void DrawInspectionROI();
