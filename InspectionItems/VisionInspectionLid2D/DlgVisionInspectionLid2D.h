...
class VisionInspectionLid2D;
class VisionInspectionLid2DPara;
struct ProcessingDlgInfo;

//HDR_6_________________________________ Header body
//
class CDlgVisionInspectionLid2D : public CDialog
{
    DECLARE_DYNAMIC(CDlgVisionInspectionLid2D)

public:
    CDlgVisionInspectionLid2D(const ProcessingDlgInfo& procDlgInfo, VisionInspectionLid2D* pVisionInsp,
        CWnd* pParent = NULL); // 표준 생성자입니다.
    virtual ~CDlgVisionInspectionLid2D();
...
public:
    ...
    VisionInspectionLid2D* m_pVisionInsp;
    VisionInspectionLid2DPara* m_pVisionPara;
