...
class VisionInspectionPatch3D;
class VisionInspectionPatch3DPara;
struct ProcessingDlgInfo;

//HDR_6_________________________________ Header body
//
class CDlgVisionInspectionPatch3D : public CDialog
{
    DECLARE_DYNAMIC(CDlgVisionInspectionPatch3D)

public:
    CDlgVisionInspectionPatch3D(const ProcessingDlgInfo& procDlgInfo, VisionInspectionPatch3D* pVisionInsp,
        CWnd* pParent = NULL); // 표준 생성자입니다.
    virtual ~CDlgVisionInspectionPatch3D();
...
public:
    ...
    VisionInspectionPatch3D* m_pVisionInsp;
    VisionInspectionPatch3DPara* m_pVisionPara;
...
public:
    ...
    void DrawPatchHeightROI();
    void DrawInterposerRefROI();

    void ClickedButtonImageCombine();
    void ClickedButtonImportInterposerRefROI_MapData();
    void ClickedButtonExportInterposerRefROI_MapData();
