...
//
VisionInspectionPackageSizePara::VisionInspectionPackageSizePara(void)
{
    Init();
}
...
BOOL VisionInspectionPackageSizePara::LinkDataBase(BOOL bSave, CiDataBase& db)
{
...
void VisionInspectionPackageSizePara::Init()
{
}

std::vector<CString> VisionInspectionPackageSizePara::ExportAlgoParaToText(
