...
//
class CDlgVisionInspection2DMatrix : public CDialog
{
    DECLARE_DYNAMIC(CDlgVisionInspection2DMatrix)

public:
    CDlgVisionInspection2DMatrix(const ProcessingDlgInfo& procDlgInfo, VisionInspection2DMatrix* pVisionInsp,
        CWnd* pParent = NULL); // 표준 생성자입니다.
    virtual ~CDlgVisionInspection2DMatrix();
...
public:
    ...
    VisionInspection2DMatrix* m_pVisionInsp;
    VisionInspection2DMatrixPara* m_pVisionPara;
