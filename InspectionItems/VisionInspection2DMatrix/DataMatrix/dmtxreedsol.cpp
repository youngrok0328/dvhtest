...
/* $Id: dmtxreedsol.c 391 2008-08-06 02:37:40Z mblaughton $ */
...
DecodeCheckErrors(unsigned char *code, int sizeIdx, int fix)
{
   ...
   for(i = 0; i < interleavedBlocks; i++) {
      ...
      rs = (struct rs*) init_rs_char(blockErrorWords, 255 - blockTotalWords);
      if(rs == NULL)
         return DMTX_FAILURE;
      ...
      fixedErr = decode_rs_char(rs, data, (int*) NULL, 0, fix);
