...
class VisionInspectionPatch2D;
class VisionInspectionPatch2DPara;
struct ProcessingDlgInfo;

//HDR_6_________________________________ Header body
//
class CDlgVisionInspectionPatch2D : public CDialog
{
    DECLARE_DYNAMIC(CDlgVisionInspectionPatch2D)

public:
    CDlgVisionInspectionPatch2D(const ProcessingDlgInfo& procDlgInfo, VisionInspectionPatch2D* pVisionInsp,
        CWnd* pParent = NULL); // 표준 생성자입니다.
    virtual ~CDlgVisionInspectionPatch2D();
...
public:
    ...
    VisionInspectionPatch2D* m_pVisionInsp;
    VisionInspectionPatch2DPara* m_pVisionPara;
