...
IMPLEMENT_DYNAMIC(CDlgVisionInspectionPatch2D, CDialog)

CDlgVisionInspectionPatch2D::CDlgVisionInspectionPatch2D(
    const ProcessingDlgInfo& procDlgInfo, VisionInspectionPatch2D* pVisionInsp, CWnd* pParent /*=NULL*/)
    : CDialog(CDlgVisionInspectionPatch2D::IDD, pParent)
...
void CDlgVisionInspectionPatch2D::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlgVisionInspectionPatch2D, CDialog)
//ON_WM_CREATE()
ON_WM_CLOSE()
ON_WM_DESTROY()
ON_BN_CLICKED(IDC_BUTTON_INSPECT, &CDlgVisionInspectionPatch2D::OnBnClickedButtonInspect)
ON_NOTIFY(TCN_SELCHANGE, IDC_TAB_RESULT, &CDlgVisionInspectionPatch2D::OnTcnSelchangeTabResult)
ON_BN_CLICKED(IDC_BUTTON_CLOSE, &CDlgVisionInspectionPatch2D::OnBnClickedButtonClose)
ON_CBN_SELCHANGE(IDC_COMBO_CURRPANE, &CDlgVisionInspectionPatch2D::OnCbnSelchangeComboCurrpane)
ON_BN_CLICKED(IDC_BUTTON_PREIMAGE, &CDlgVisionInspectionPatch2D::OnBnClickedButtonPreimage)
ON_BN_CLICKED(IDC_BUTTON_NEXTIMAGE, &CDlgVisionInspectionPatch2D::OnBnClickedButtonNextimage)
ON_MESSAGE(UM_ROI_CHANGED, &CDlgVisionInspectionPatch2D::OnRoiChanged)
ON_MESSAGE(UM_SHOW_DETAIL_RESULT, &CDlgVisionInspectionPatch2D::OnShowDetailResult)
ON_MESSAGE(XTPWM_PROPERTYGRID_NOTIFY, &CDlgVisionInspectionPatch2D::OnGridNotify)
ON_MESSAGE(UM_IMAGE_LOT_VIEW_PANE_CHANGED, &CDlgVisionInspectionPatch2D::OnImageLotViewPaneSelChanged)
END_MESSAGE_MAP()

BOOL CDlgVisionInspectionPatch2D::OnInitDialog()
{
...
int CDlgVisionInspectionPatch2D::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CDlgVisionInspectionPatch2D::OnDestroy()
{
    CDialog::OnDestroy();
...
void CDlgVisionInspectionPatch2D::OnClose()
{
    CDialog::OnDestroy();
}

void CDlgVisionInspectionPatch2D::SetInitDialog()
{
}

void CDlgVisionInspectionPatch2D::SetInitParaWindow()
{
}

void CDlgVisionInspectionPatch2D::SetInitButton()
{
    CRect rtDlg;
    GetClientRect(rtDlg);
...
void CDlgVisionInspectionPatch2D::OnBnClickedButtonInspect()
{
...
void CDlgVisionInspectionPatch2D::OnTcnSelchangeTabResult(NMHDR* /*pNMHDR*/, LRESULT* pResult)
{
...
void CDlgVisionInspectionPatch2D::OnBnClickedButtonClose()
{
    OnCancel();
}

void CDlgVisionInspectionPatch2D::ShowPrevImage()
{
...
void CDlgVisionInspectionPatch2D::ShowNextImage()
{
    // Image Display 를 위한 테스트 코드
    if (m_pVisionInsp->getImageLotInsp().m_vecImages[m_pVisionInsp->GetCurVisionModule_Status()].size() == 0)
        return;
...
void CDlgVisionInspectionPatch2D::ShowImage(BOOL bChange)
{
...
void CDlgVisionInspectionPatch2D::OnCbnSelchangeComboCurrpane()
{
    m_imageLotView->Overlay_RemoveAll();
    m_imageLotView->Overlay_Show(TRUE);
...
void CDlgVisionInspectionPatch2D::OnBnClickedButtonPreimage()
{
    ShowPrevImage();
}

void CDlgVisionInspectionPatch2D::OnBnClickedButtonNextimage()
{
    ShowNextImage();
}

LRESULT CDlgVisionInspectionPatch2D::OnRoiChanged(WPARAM /*wParam*/, LPARAM /*lParam*/)
{
    GetROI();
    ShowCharBinImage();
...
BOOL CDlgVisionInspectionPatch2D::ShowCharBinImage()
{
    return TRUE;
}

LRESULT CDlgVisionInspectionPatch2D::OnShowDetailResult(WPARAM wparam, LPARAM /*lparam*/)
{
...
void CDlgVisionInspectionPatch2D::UpdatePropertyGrid()
{
...
LRESULT CDlgVisionInspectionPatch2D::OnGridNotify(WPARAM wparam, LPARAM lparam)
{
...
void CDlgVisionInspectionPatch2D::ClickedButtonImageCombine()
{
...
void CDlgVisionInspectionPatch2D::GetROI()
{
}

void CDlgVisionInspectionPatch2D::SetROI()
{
}

LRESULT CDlgVisionInspectionPatch2D::OnImageLotViewPaneSelChanged(WPARAM /*wparam*/, LPARAM /*lparam*/)
{
...
void CDlgVisionInspectionPatch2D::DrawEdgeSearchROI()
{
    m_imageLotView->Overlay_RemoveAll();
