...
//
class CDlgMarkTeachResultViewer : public CDialog
{
    DECLARE_DYNAMIC(CDlgMarkTeachResultViewer)

public:
    CDlgMarkTeachResultViewer(CWnd* pParent = NULL); // 표준 생성자입니다.
    virtual ~CDlgMarkTeachResultViewer();
