...
//
#define __VISION_MAPDATA_EDITOR_CLASS_EXPORT__

#define MAPDATA_ID_CHIP 0
#define MAPDATA_ID_PASSIVE 1
#define MAPDATA_ID_ARRAY 2
#define MAPDATA_ID_HEATSYNC 3
#define MAPDATA_ID_PATCH 4
#define MAPDATA_ID_BALL 100
