...
public:
    // Spec 정보로 가공된 데이터
    float m_specPocketSizeX_px = 0.f;
    float m_specPocketSizeY_px = 0.f;
    Ipvm::Rect32r m_specPocketRect_px = {0.f, 0.f, 0.f, 0.f};
    ...
    Ipvm::Quadrangle32r m_alignedPocket{Ipvm::k_noiseValue32r, Ipvm::k_noiseValue32r, Ipvm::k_noiseValue32r,
