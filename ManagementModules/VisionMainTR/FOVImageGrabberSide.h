...
//
class FOVImageGrabberSide : public FOVImageGrabber
{
public:
    FOVImageGrabberSide(VisionMainTR* visionMain);
    virtual ~FOVImageGrabberSide();
...
protected:
    ...
    std::vector<std::shared_ptr<FOVBuffer>> m_buffers[enSideVisionModule::SIDE_VISIONMODULE_END];
