...
{
public:
    InlineGrab(VisionMainTR* main, long grabBufferNum, VisionUnit** unitBuffers, long unitNum);
    ~InlineGrab();
    ...
    void initializeTR(long totalFrameCount, long highPosFrameCount);
...
private:
    ...
    void ImageGrabTR(long grabBufferIndex);
