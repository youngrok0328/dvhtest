...
class VisionProcessingOtherAlignPara;
class VisionProcessingGlobalMaskMaker;
class VisionProcessingAlign2D;
class VisionProcessingAlign2DPara;
class VisionProcessingAlign3D;
class VisionProcessingCoupon2D; //SDY_Coupon2D
class VisionProcessingSideDetailAlign;
class VisionProcessingNGRV; //MED#6_NGRV_JHB
...
class VisionInspectionBgaBallBridge;
...
class VisionInspectionLid2D; //kircheis_InspLID
class VisionInspectionLid3D; //kircheis_InspLID
class VisionInspectionPatch2D; //kircheis_POI
class VisionInspectionPatch3D; //kircheis_POI
class VisionInspectionDie2D; //kircheis_InspLID
class VisionInspectionSurface;
class VisionInspectionSurfacePara;
class VisionInspectionGeometry;
class VisionInspectionKOZ2D; //kircheis_KOZ
class VisionInspectionIntensityChecker2D; //SDY_IntensityChecker
...
public:
    ...
    // Processing modules
    VisionProcessingSpec* m_visionProcessingSpec_PackageLayoutEditor;
    VisionProcessingFOV* m_VisionProcessingFOV;
    VisionProcessingFiducialAlign* m_visionProcessingFiducialAlign;
    VisionProcessingPadAlign2D* m_visionProcessingPadAlign2D;
    VisionProcessingOtherAlign* m_visionProcessingOtherAlign;
    VisionProcessingGlobalMaskMaker* m_visionProcessingGlobalMaskMaker;
    VisionProcessingAlign2D* m_visionProcessingAlign2D;
    VisionProcessingAlign3D* m_visionProcessingAlign3D;
    VisionProcessingCoupon2D* m_visionProcessingCoupon2D; //SDY_Coupon2D
    VisionProcessingSideDetailAlign* m_visionProcessingSideDetailAlign;
    VisionProcessingNGRV* m_visionProcessingNGRV; //MED#6_NGRV_JHB

    // Inspection modules
    VisionInspectionBgaBottom2D* m_visionInspectionBgaBottom2D;
    VisionInspectionBgaBottom3D* m_visionInspectionBgaBottom3D;
    VisionInspectionComponent2D* m_visionInspectionComponent2D;
    VisionInspectionComponent3D* m_visionInspectionComponent3D;
    VisionInspection2DMatrix* m_visionInspection2DMatrix;
    VisionInspectionPackageSize* m_visionInspectionPackageSize;
    VisionInspectionBgaBallBridge* m_visionInspectionBgaBallBridge;
    VisionInspectionBgaBallPixelQuality* m_visionInspectionBgaBallPixelQuality;
    VisionInspectionLgaBottom2D* m_visionInspectionLgaBottom2D;
    VisionInspectionLgaBottom3D* m_visionInspectionLgaBottom3D;
    VisionInspectionLid2D* m_visionInspectionLid2D; //kircheis_InspLID
    VisionInspectionLid3D* m_visionInspectionLid3D; //kircheis_InspLID
    VisionInspectionPatch2D* m_visionInspectionPatch2D; //kircheis_POI
    VisionInspectionPatch3D* m_visionInspectionPatch3D; //kircheis_POI
    VisionInspectionDie2D* m_visionInspectionDie2D; //kircheis_InspLID
    VisionInspectionKOZ2D* m_visionInspectionKOZ2D; //kircheis_KOZ
    VisionInspectionIntensityChecker2D* m_visionInspectionIntensityChecker2D; //SDY_IntensityChecker
    VisionInspectionGlassSubstrate2D* m_visionInspectionGlassSubstrate2D;
    VisionInspectionSide2D* m_visionInspectionSide2D;
    std::vector<VisionInspectionSurface*> m_visionInspectionSurfaces;
    std::vector<VisionInspectionMark*> m_visionInspectionMarks;
