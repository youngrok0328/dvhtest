...
응용 프로그램 마법사에서 이 Button DLL을 만들었습니다. 이 DLL은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 DLL을 작성하기 위한 기본 구조를 제공합니다.

이 파일에는 Button DLL을 구성하는 각 파일에 대한 요약 설명이 포함되어 있습니다.
...
Button.h
    해당 DLL의 기본 헤더 파일이며, CButtonApp 클래스가 선언되어 있습니다.

Button.cpp
    기본 DLL 소스 파일입니다. CButtonApp 클래스가 포함되어 있습니다.
