...
class __INTEKPLUS_SHARED_GRIDCTRL_API__ CGridCell : public CGridCellBase
{
...
protected:
    ...
    int m_nImage{-1}; // Index of the list view item뭩 icon
    DWORD m_nFormat{(DWORD)-1};
    COLORREF m_crFgClr{CLR_DEFAULT};
    COLORREF m_crBkClr{CLR_DEFAULT};
    LOGFONT* m_plfFont{};
    UINT m_nMargin{(UINT)-1};
...
class __INTEKPLUS_SHARED_GRIDCTRL_API__ CGridDefaultCell : public CGridCell
{
