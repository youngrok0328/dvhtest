...
//
class __INTEKPLUS_SHARED_GRIDCTRL_API__ CTreeColumn
{
public:
    CTreeColumn();
    virtual ~CTreeColumn();
...
public:
    ...
    virtual void SetBkClr(COLORREF crBkClr)
    {
        m_crBkClr = crBkClr;
    }
    virtual COLORREF GetBkClr() const
    {
        return m_crBkClr;
    }

    virtual void SetFgClr(COLORREF crFgClr)
    {
        m_crFgClr = crFgClr;
    }
    virtual COLORREF GetFgClr() const
    {
        return m_crFgClr;
    }
    ...
    virtual void SetAllowDraw(BOOL bAllowDraw)
    {
        m_bAllowDraw = bAllowDraw;
    }
    virtual BOOL GetAllowDraw() const
    {
        return m_bAllowDraw;
    }
    ...
    virtual void SetColumnWithTree(int iColumnWithTree)
    {
        m_iColumnWithTree = iColumnWithTree;
    }
    virtual int GetColumnWithTree() const
    {
        return m_iColumnWithTree;
    }

    virtual void SetDefTreeIndent(int nDefTreeIndent)
    {
        m_nDefTreeIndent = nDefTreeIndent;
    }
    virtual int GetDefTreeIndent() const
    {
        return m_nDefTreeIndent;
    }

    virtual void SetFixedRowCount(int iFixedRowCount)
    {
        m_iFixedRowCount = iFixedRowCount;
    }
    virtual int GetFixedRowCount() const
    {
        return m_iFixedRowCount;
    }

    virtual void SetRowCount(int iRowCount)
    {
...
public:
    ...
    int InsertTreeBranch(const unsigned char* apucTreeLevelAry, // Tree Level data array --
    ...
    BOOL GetTreeUsesImages() const
    {
        return m_bTreeUsesImages;
    }
    ...
    {
        return m_bShowTreeLines;
    }

    void SetTreeLineColor(COLORREF clr)
    {
        m_crTreeLineColour = clr;
    }
    COLORREF GetTreeLineColor() const
    {
        return m_crTreeLineColour;
    }
    ...
    //TreeDisplayOutline(long aiNbrElements, const unsigned char* apucTreeLevelAry,const unsigned char* apucTreeViewAry);
