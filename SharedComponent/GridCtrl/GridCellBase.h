...
#define GVIF_ALL \
    (GVIF_TEXT | GVIF_IMAGE | GVIF_PARAM | GVIF_STATE | GVIF_BKCLR | GVIF_FGCLR | GVIF_FORMAT | GVIF_FONT | GVIF_MARGIN)
...
class __INTEKPLUS_SHARED_GRIDCTRL_API__ CGridCellBase : public CObject
{
...
private:
    CCellRange m_MergeRange{-1, -1, -1, -1};
    bool m_IsMergeWithOthers{};
    CCellID m_MergeCellID{-1, -1};
    bool m_Hide{};
};
