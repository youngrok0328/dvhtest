...
PackageSpec_BallSource::PackageSpec_BallSource(LPCSTR name, long index, double posX_um, double posY_um, double diameter_um, double height_um)
	: m_name(name)
	, m_index(index)
	, m_posX_um(posX_um)
	, m_posY_um(posY_um)
...
BOOL PackageSpec_BallSource::LinkDataBase(BOOL bSave, CiDataBase &db)
{
