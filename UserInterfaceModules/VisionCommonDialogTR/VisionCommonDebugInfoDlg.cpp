...
BOOL VisionCommonDebugInfoDlg::OnInitDialog()
{
    ...
    auto firstColumnWidth = max(1, rect.Width() - type_width - 40);
    m_pGridCtrl->SetColumnWidth(0, firstColumnWidth);
...
void VisionCommonDebugInfoDlg::OnSize(UINT nType, int cx, int cy)
{
