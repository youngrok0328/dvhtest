// GridSlideBox.cpp: implementation of the CGridSlideBox class.
//
//////////////////////////////////////////////////////////////////////
...
CGridSlideBox::CGridSlideBox() : CGridCell()
{
	m_bEnabled = TRUE;
	m_nSelect	= -1;
	m_nClick	= 0;
...
{
	if (m_nSelect < 0 || m_nSelect >= (long)m_vecItem.size())
	{
		return _T("");
	}
...
//    BOOL bResult = CGridCell::Draw(pDC, nRow, nCol, rect,  bEraseBkgnd);
   ...
   // Do the draw 
	if(m_nSelect>=0 && (long)m_vecItem.size() > m_nSelect)
	{
...
BOOL CGridSlideBox::Edit(int nRow, int nCol, CRect /* rect */, CPoint /* point */, 
						   UINT /* nID */, UINT nChar)
{
	if (m_bEnabled)
	{
