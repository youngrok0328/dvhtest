...
class dPI_GridCtrlDEF_API CGridCtrl : public CWnd
{
...
public:
	...
	BOOL SortNumItems(int nCol, BOOL bAscending, LPARAM data = 0);
...
public:
    void Print(int nOption, CPrintDialog* pPrntDialog = NULL);
...
public:
    ...
    virtual void OnPrint(CDC *pDC, CPrintInfo *pInfo,int nOption);
